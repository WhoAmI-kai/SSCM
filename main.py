...
if __name__ == "__main__":
    ...
    for i, data in enumerate(data_iter):
        # if data.seq_id.item() == 36988 or data.seq_id.item() == 2397 or data.seq_id.item() == 14851:
        #     continue
        ...
        attack = Attack(model, dataset=data, agt_num=19, centerlane_dis=centerlane_dis, max_iterations=20000,
        ...
        ae_path = './AE_filter_left/AE/' + str(seq_id) + '.pt'
